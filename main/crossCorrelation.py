def xcorr(
	...
	# Set [0,0] to 0 and normalize regarding pixelsize
	...
	#Circular mask to restrict cross-correlation. 
	#Hp=100 in both dimensions seems ideal, lp has to be =0
	corr_mask = bp_mask(img1.shape, bandpass_outer_radius, 0, 0)
	
	#Case 1: with bandpass mask (recommended)
